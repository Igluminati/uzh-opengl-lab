...
The intensity fades smoothly between these two angles so it doesn't look harsh. Outside the cone, you've only got the ambient light (despite diffuse and specular being enabled) so objects aren't completely black.
